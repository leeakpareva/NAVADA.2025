...
const expertise = [
  ...
  },
  {
    icon: BookOpen,
    title: 'Education',
    description: "MBA and Master's in Project Management from Northumbria University."
  },
  {
    icon: Gem,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Led by Leslie Akpareva, NAVADA is a transformative initiative designed to harness 
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h3 className="text-3xl font-bold">Leslie Akpareva</h3>
            <p className="text-gray-400">
              ...
              digital, energy, logistics, and travel industries.
            </p>
